...
import com.zyzl.weixin.api.enums.MaterialType;
import com.zyzl.weixin.api.enums.ResultType;
import com.zyzl.weixin.api.response.*;
...
public class MaterialAPI extends BaseAPI {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(com.zyzl.weixin.api.MaterialAPI.class);
