...
import com.zyzl.weixin.api.enums.QrcodeType;
import com.zyzl.weixin.api.response.BaseResponse;
import com.zyzl.weixin.api.response.QrcodeResponse;
...
public class QrcodeAPI extends BaseAPI {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(com.zyzl.weixin.api.QrcodeAPI.class);
