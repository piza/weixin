...
import com.zyzl.weixin.api.enums.MenuType;
...
public class MenuButton extends BaseModel {
    ...
    private List<com.zyzl.weixin.api.entity.MenuButton> subButton;
    ...
    public List<com.zyzl.weixin.api.entity.MenuButton> getSubButton() {
        return subButton;
    }

    public void setSubButton(List<com.zyzl.weixin.api.entity.MenuButton> subButton) {
