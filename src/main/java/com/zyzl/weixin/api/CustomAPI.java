...
import com.zyzl.weixin.api.response.GetCustomAccountsResponse;
...
public class CustomAPI extends BaseAPI {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(com.zyzl.weixin.api.CustomAPI.class);
