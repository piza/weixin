...
public enum ResultType {
     ...
     * @return 结果枚举对象
     */
    public static com.zyzl.weixin.api.enums.ResultType get(String code) {
        BeanUtil.requireNonNull(code, "code is null");
        com.zyzl.weixin.api.enums.ResultType[] list = values();
        for (com.zyzl.weixin.api.enums.ResultType resultType : list) {
