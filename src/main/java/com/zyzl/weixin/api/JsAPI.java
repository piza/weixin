...
import com.zyzl.weixin.api.response.GetSignatureResponse;
import com.zyzl.weixin.util.BeanUtil;
import com.zyzl.weixin.util.JsApiUtil;
...
public class JsAPI extends BaseAPI {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(com.zyzl.weixin.api.JsAPI.class);
