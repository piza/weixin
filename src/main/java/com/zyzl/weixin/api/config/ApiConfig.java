...
public final class ApiConfig extends Observable implements Serializable {
    ...
    private static final Logger logger = LoggerFactory.getLogger(com.zyzl.weixin.api.config.ApiConfig.class);
    /**
        ...
        NetWorkCenter.get(url, null, new NetWorkCenter.ResponseCallback() {
            ...
            public void onResponse(int resultCode, String resultJson) {
                if (HttpStatus.SC_OK == resultCode) {
                    ...
                    //设置通知点
                    setChanged();
                    notifyObservers(new com.zyzl.weixin.api.config.ConfigChangeNotice(appid, ChangeType.ACCESS_TOKEN, accessToken));
                }
            }
        });
        //刷新工作做完，将标识设置回false
