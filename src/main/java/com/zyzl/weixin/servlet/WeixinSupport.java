package com.zyzl.weixin.servlet;

import com.zyzl.weixin.handle.EventHandle;
import com.zyzl.weixin.handle.MessageHandle;
import com.zyzl.weixin.message.BaseMsg;
import com.zyzl.weixin.message.TextMsg;
import com.zyzl.weixin.message.aes.AesException;
import com.zyzl.weixin.message.aes.WXBizMsgCrypt;
import com.zyzl.weixin.message.req.*;
import com.zyzl.weixin.util.MessageUtil;
import com.zyzl.weixin.util.SignUtil;
...
import static com.zyzl.weixin.util.BeanUtil.isNull;
import static com.zyzl.weixin.util.BeanUtil.nonNull;
import static com.zyzl.weixin.util.CollectionUtil.isEmpty;
import static com.zyzl.weixin.util.CollectionUtil.isNotEmpty;
import static com.zyzl.weixin.util.StrUtil.isNotBlank;
...
public abstract class WeixinSupport {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(com.zyzl.weixin.servlet.WeixinSupport.class);
    // 充当锁
    ...
    public String processRequest(HttpServletRequest request) {
        ...
        System.out.println("收到微信消息:" + fromUserName + "," + msgType);
