...
import com.zyzl.weixin.company.handle.QYEventHandle;
import com.zyzl.weixin.company.handle.QYMessageHandle;
import com.zyzl.weixin.company.message.req.*;
import com.zyzl.weixin.company.message.resp.QYBaseRespMsg;
import com.zyzl.weixin.company.message.resp.QYTextRespMsg;
...
public abstract class QYWeixinSupport{
    ...
    private static final Logger LOG = LoggerFactory.getLogger(com.zyzl.weixin.servlet.QYWeixinSupport.class);
